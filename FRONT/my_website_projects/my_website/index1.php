...
<body>
		...
		<div class="form-container">
			...
			<div class="fields">
				<form class="ajax-contact-form" action="">
					<p><input type="text" name="nom" value="" placeholder="Имя"></p>
					<div class="row">
						<div class="col"><input type="phone" name="tel" value="" placeholder="Телефон"></div>
	...
	<!-- <script src="contact-ajax.js"></script> -->
</body>
