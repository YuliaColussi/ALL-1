...
class B extends A 
{
    ...
    {
        $nb = parent::calcul(); //parent fonctionne pour appeler une méthode d'une classe parente lors d'une surcharge (override) , permet d'améliorer ou de changer le comportement d'une méthode
